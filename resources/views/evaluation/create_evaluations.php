...
<section>
	...
	<div class="content">
		...
		<?php if($check_data->parts->count() > 0){?>
	  		<?php if(!empty($check_data)){ ?>
				<?php foreach ($check_data->parts as $key => $value) : ?>
					<div class="new-part">
			            <div class="panel panel-default">
				            <div class="box-tools pull-right">
				                <button type="button" class="btn btn-box-tool btn-remove-part" data-widget="remove" data-id="<?php echo $value->id_part; ?>"><i class="fa fa-remove"></i>
				                </button>
				            </div>
			                <div class="panel-body">
			                    ...
			                    <input type="number" name="percent-<?php echo $id_new_evaluation.'-'.$value->chapter;?>" class="form-control required percent" placeholder="30" value="" id="percent">
