...
class FormViewRequestLeaves
{
	 public static function getViewRequestLeaves($data,$company_time,$leaves_type, $header,$leaves_format,$company_info){  
                 ...
                 if($value['id_leaves_format'] == 2){ // half_leave
                    ...
                    $form_leave .='</div><br>';
                      ...
                      $form_leave .='เหตุผลการลา<br>';
                        $form_leave .='<textarea class="form-control textarea g-disable-input" readonly placeholder="type..." rows="5" id="edit-input-reason-leave-reason">'.$value['reason'].'</textarea><br>';
                    
                    if(!empty($value["reason_approvers"])){
                        $form_leave .='เหตุผลที่ไม่อนุมัติ';
                        $form_leave .='<br>';
                        $form_leave .='<textarea class="form-control textarea g-disable-input required"  readonly rows="3" id="reason-request-time-stamp" >'.$value["reason_approvers"].'</textarea>';
                        $form_leave .='<label class="text-error" id="reason-request-time-stamp-text-error"></label>';
                        $form_leave .='<br>';
                    }
                }
        return $form_leave;
