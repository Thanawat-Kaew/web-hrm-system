		...
		$form = '<div class="row">';
            $form .= '<div class="col-md-8 col-md-offset-2" >';
                ...
                $form .= '<input type="hidden" value="" id="id_employee">';
                    ...
                    $form .= '</div>';
                    $form .= '<label class="text-error" id="name_sender-text-error"></label>';
                    ...
                    $form .= '</div>';
                    $form .= '<label class="text-error" id="email_sender-text-error"></label>';
                    ...
                    $form .= '</div>';
                    $form .= '<label class="text-error" id="name_reciver-text-error"></label>';
                    ...
                    $form .= '</div>';
                    $form .= '<label class="text-error" id="email_reciver-text-error"></label>';
                    ...
                    $form .= '<div class="input-group topic">';
                        $form .= '<div class="input-group-addon">';
                             $form .= '<i class="fa fa-user-secret"></i>';
                        $form .= '</div>';
                        $form .= '<input class="form-control required " type="text" value=""  placeholder="simple@example.com" id="topic">';
                    $form .= '</div>';
                    $form .= '<label class="text-error" id="topic-text-error"></label>';
                    ...
                    $form .= '<div class="input-group details">';
                        $form .= '<div class="input-group-addon">';
                             $form .= '<i class="fa fa-user-secret"></i>';
                        $form .= '</div>';
                        $form .= '<textarea class="form-control required " type="text" value=""  placeholder="simple@example.com" id="details" rows="4" cols="50">';
                        $form .= '</textarea>';
                    $form .= '</div>';
