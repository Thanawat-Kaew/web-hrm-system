...
class FormRepository
{
    ...
    public static function getFormNewTimeClock($header){
        $form_new_time_clock  = '<div class="box-body">';
            ...
            $form_new_time_clock .= '<div class="input-group col-md-12">';
                ...
                $form_new_time_clock .='<input  value=""  placeholder="เลือกวันที่..."  class="form-control datepicker required" id="date-history">';
            $form_new_time_clock .='</div>';
            ...
            $form_new_time_clock .='<div class="input-group col-md-12">';
                ...
                $form_new_time_clock .='</div>';
                $form_new_time_clock .='<input value=""  class="form-control timepicker required" id="time-in-history">';
            $form_new_time_clock .='</div>';
            ...
            $form_new_time_clock .='<div class="input-group col-md-12">';
                $form_new_time_clock .='<div class="input-group-addon">';
                    $form_new_time_clock .='<i class="fa fa-clock-o"></i>';
                $form_new_time_clock .='</div>';
                $form_new_time_clock .='<input value=""  class="form-control timepicker required" id="break-out-history">';
            $form_new_time_clock .='</div>';
            ...
            $form_new_time_clock .='<div class="input-group col-md-12">';
                $form_new_time_clock .='<div class="input-group-addon">';
                    $form_new_time_clock .='<i class="fa fa-clock-o"></i>';
                $form_new_time_clock .='</div>';
                $form_new_time_clock .='<input value=""  class="form-control timepicker required" id="break-in-history">';
            $form_new_time_clock .='</div>';
            ...
            $form_new_time_clock .='<div class="input-group col-md-12">';
                $form_new_time_clock .='<div class="input-group-addon">';
                    $form_new_time_clock .='<i class="fa fa-clock-o"></i>';
                $form_new_time_clock .='</div>';
                $form_new_time_clock .='<input value="" class="form-control timepicker required" id="time-out-history" >';
            $form_new_time_clock .='</div>';
            ...
            $form_new_time_clock .='ผู้ที่จะอนุมัติ';
            $form_new_time_clock .='<div class="input-group col-md-12">';
                $form_new_time_clock .='<div class="input-group-addon">';
                    $form_new_time_clock .='<i class="fa fa-user"></i>';
                $form_new_time_clock .='</div>';
                $form_new_time_clock .='<input value="'.$header['first_name'].' '.$header['last_name'].'" readonly class="form-control" id="approved">';
            $form_new_time_clock .='</div>';
            $form_new_time_clock .='<br>';
    ...
    public static function getViewDataRequestForgetToTime($data){
        $form  = '<div class="box-body">';
            ...
            $form .= '<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-calendar"></i>';
                $form .='</div>';
                $form .='<input  value="'.$data["date"].'" readonly  class="form-control datepicker required" id="view-date-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-date-request-forget-to-time-text-error"></label>';
            $form .='<br>';
            ...
            $form .='<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-clock-o"></i>';
                $form .='</div>';
                $form .='<input value="'.$data["time"].'"  readonly class="form-control timepicker required" id="view-time-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-time-request-forget-to-time-text-error"></label>';
            $form .='<br>';
            ...
            $form .='<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-clock-o"></i>';
                $form .='</div>';
                $form .='<input value="'.$data["type_time"].'"  readonly class="form-control timepicker required" id="view-type-time-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-type-time-request-forget-to-time-text-error"></label>';
            $form .='<br>';

            $form .='เหตุผล';
            $form .='<br>';
            $form .='<textarea class="form-control textarea g-disable-input required"  readonly rows="5" id="view-reason-request-forget-to-time" >'.$data["reason"].'</textarea>';
            $form .='<label class="text-error" id=view-reason-request-forget-to-time-text-error"></label>';
            $form .='<br>';
    ...
    public static function getViewDetailRequestForgetToTime($data){
        $form  = '<div class="box-body">';
            ...
            $form .= '<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-calendar"></i>';
                $form .='</div>';
                $form .='<input  value="'.$data["date"].'" readonly  class="form-control datepicker required" id="view-detail-date-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-detail-date-request-forget-to-time-text-error"></label>';
            $form .='<br>';
            ...
            $form .='<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-clock-o"></i>';
                $form .='</div>';
                $form .='<input value="'.$data["time"].'"  readonly class="form-control timepicker required" id="view-detail-time-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-detail-time-request-forget-to-time-text-error"></label>';
            $form .='<br>';
            ...
            $form .='<div class="input-group col-md-12">';
                $form .='<div class="input-group-addon">';
                    $form .='<i class="fa fa-clock-o"></i>';
                $form .='</div>';
                $form .='<input value="'.$data["type_time"].'"  readonly class="form-control timepicker required" id="view-detail-type-time-request-forget-to-time">';
            $form .='</div>';
            $form .='<label class="text-error" id="view-detail-type-time-request-forget-to-time-text-error"></label>';
            $form .='<br>';

            $form .='เหตุผล';
            $form .='<br>';
            $form .='<textarea class="form-control textarea g-disable-input required"  readonly rows="5" id="view-detail-reason-request-forget-to-time" >'.$data["reason"].'</textarea>';
            $form .='<label class="text-error" id=view-detail-reason-request-forget-to-time-text-error"></label>';
            $form .='<br>';
